...
export async function executeAuditDocument({ document, model }: AuditDocumentParams) {
  ...
  const prompt = `Conduct a rigorous, professional maritime commercial audit on this document for Comilla Traders, Chittagong Port, Bangladesh:
